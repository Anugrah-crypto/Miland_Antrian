...
<body>
  <main>
      <h1>NOMOR ANTRIAN SEKARANG ADALAH: </h1>
      ...
      <div class = "video1">
        <video id="myVideo1" width="640" height="360" autoplay loop controls>
            <source src="trailer.mp4" type="video/mp4">
        </video>
        
      <div class = "video2">
        <video id="myVideo2" width="640" height="360" autoplay loop controls>
